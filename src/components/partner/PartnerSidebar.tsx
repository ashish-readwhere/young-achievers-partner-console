    ...
    <Sidebar className="border-r bg-gradient-to-b from-blue-50 to-white w-64">
      <SidebarHeader className="p-4 border-b bg-white/50 backdrop-blur-sm">
        <div className="flex items-center gap-3">
          ...
          <div className="flex-1">
            <h2 className="font-bold text-base text-gray-900">Young Achievers</h2>
      ...
      <SidebarContent className="px-3 py-4 flex flex-col h-full overflow-y-auto">
        <SidebarGroup className="flex-1">
          <SidebarGroupLabel className="text-xs uppercase tracking-wide text-gray-500 font-semibold mb-2 px-2">
            Navigation
          </SidebarGroupLabel>
          <SidebarGroupContent>
              ...
              {menuItems.map((item) => (
                <SidebarMenuItem key={item.id}>
                  <SidebarMenuButton 
                    ...
                    className="w-full justify-start gap-3 px-3 py-2.5 text-gray-700 hover:bg-blue-100 hover:text-blue-700 data-[active=true]:bg-blue-100 data-[active=true]:text-blue-700 data-[active=true]:border-r-4 data-[active=true]:border-blue-500 rounded-lg transition-all duration-200 group min-h-[48px]"
                  >
                    <button 
